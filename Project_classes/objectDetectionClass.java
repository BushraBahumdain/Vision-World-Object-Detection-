...
public class objectDetectionClass {
    ...
    private List<String> loadLabelList(AssetManager assetManager, String labelPath) throws IOException {
        ...
        String line;
        // to loop through each line and store it to labelList
    ...
    public Mat recognizeImage(Mat mat_image){
        ...
        // creating treemap of three array (boxes,score,classes)
        ...
        // as output has only 10 boxes in the image
        for (int i=0;i<10;i++) {
            ...
            if (score_value > 0.5) {
                ...
                Imgproc.rectangle(rotated_mat_image, new Point(left, top), new Point(right, bottom), new Scalar(0, 255, 255, 255), 2);
                // to write text on frame
                // string of class name of object  // starting point                         // color of text           // size of text
                Imgproc.putText(rotated_mat_image, labelList.get((int) class_value), new Point(left, top), 3, 1, new Scalar(0, 255, 255, 255), 2);

                CameraActivity.tts.speak(labelList.get((int) class_value), TextToSpeech.QUEUE_FLUSH, null);
            }
        }

        // rotating back by -90 degree before returning 
